	...
	public partial class Meniu : Form
	{
        ...
        private void button3_Click(object sender, EventArgs e)//BUTON JOC NOU
        {
			...
			do
			{
				if (difficulty == 0)
				{
					text = cuvinte0[rn.Next(1, cuvinte0.Length) - 1];
				}
				else
				{
					text = cuvinte1[rn.Next(1, cuvinte1.Length) - 1];
				}
				form2 = new Joc(difficulty,text);
